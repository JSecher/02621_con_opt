...
for j=1:length(x0s)
    ...
    data(j,:) = [fval, sol_fmin', time_fmincon, ...
                 fval_grad, sol_fmin_grad', time_fmincon_grad, ...
...
input.tableRowLabels = {'$\f(x)_{\text{fmincom}} =$', ...
                        '$x_{\text{fmincom}} = $', '', ...
                        '$\text{Time}_{\text{fmincom}}', ...
                        '$\f(x)_{\text{fmincom grad}} =$', ...
                        '$x_{\text{fmincom  grad}} = $', '', ...
                        '$\text{Time}_{\text{fmincom  grad}}', ...
                        '$\f(x)_{\text{CasADi}} =$', ...
                        '$x_{\text{CasADi}} = $', '', ...
                        '$\text{Time}_{\text{CasADi}}'};
